...
{
 d=verify_operand(argv,argc);
 printf("\n ****************d=%d****************** after operand check",d);
 if(d==-1)
  return ;
 printf("\n ****************d=%d****************** before operator check",d);
 //printf("\n ************************************* after operand");
...
int notenough_args(int argc)
{
 if(argc!=4)
 {
  printf("\n ERROR no of arguments are wrongly specified argc=%d ",argc);
