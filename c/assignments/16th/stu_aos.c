 ...
 void menu()
{
 ...
 printf("\n\n **********************MENU***********************\n");      
       ...
       printf("        8 - TO OPEN SOURCE(stu_aos.c)IN VIM\n");      
       printf("        9 - TO COMPILE THE SOURCE FILE  \n");      
       printf("        0 - TO RUN stuaos.out\n\n");
 printf(" *************************************************\n");      
   return ;    
}
 ...
 void selection()
{
 ...
 switch(ch)
 {
  ...
  case '8' : system("clear");
             system("vim stu_aos.c"); 
             system("cc stu_aos.c -o stuaos.out");
             system("./stuaos.out");
             printf("\n\n GOING BACK TO THE OLD PROGRAM\n");
             exit(0);
           
  case '9' : printf("\n\tcompiling stu_aos.c\n"); 
             system("cc stu_aos.c -o stu_aos.out");
             printf(" stuaos.out created\n");
             return ;
