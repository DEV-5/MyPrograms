...
For each query of the second type, it is guaranteed that a book is present on the shelf at
index.
...
There are
shelves and requests, or queries.
...
int main()
{
	...
	total_number_of_books[i] = 0;
        total_number_of_pages[i] = (int *) NULL;
    }
    ...
    while (total_number_of_queries--) {
        ...
        if (type_of_query == 1) {
            ...
            total_number_of_pages[x] = realloc((void *)total_number_of_pages[x],
