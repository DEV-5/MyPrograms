...
#define SDIO_STA_SBitBandingERR_Pos          (9U)
#define SDIO_STA_SBitBandingERR_Msk          (0x1UL << SDIO_STA_SBitBandingERR_Pos)         /*!< 0x00000200 */
#define SDIO_STA_SBitBandingERR              SDIO_STA_SBitBandingERR_Msk                   /*!<Start bit not detected on all data signals in wide bus mode */
...
#define SDIO_ICR_SBitBandingERRC_Pos         (9U)
#define SDIO_ICR_SBitBandingERRC_Msk         (0x1UL << SDIO_ICR_SBitBandingERRC_Pos)        /*!< 0x00000200 */
#define SDIO_ICR_SBitBandingERRC             SDIO_ICR_SBitBandingERRC_Msk                  /*!<SBitBandingERR flag clear bit */
...
#define SDIO_MASK_SBitBandingERRIE_Pos       (9U)
#define SDIO_MASK_SBitBandingERRIE_Msk       (0x1UL << SDIO_MASK_SBitBandingERRIE_Pos)      /*!< 0x00000200 */
#define SDIO_MASK_SBitBandingERRIE           SDIO_MASK_SBitBandingERRIE_Msk                /*!<Start Bit Error Interrupt Enable           */
