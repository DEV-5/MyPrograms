...
/*
 * @V_DEV: look for RTC_WKUP_IRQHandler in the disassembly window and add break point
 *  and run after break point is hit observe the value of lr reigister is 0xFFFF FFFD
 */
