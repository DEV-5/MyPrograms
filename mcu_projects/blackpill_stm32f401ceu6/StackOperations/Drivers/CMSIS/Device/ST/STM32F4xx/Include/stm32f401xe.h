...
#define SDIO_STA_SStackOperationsERR_Pos          (9U)
#define SDIO_STA_SStackOperationsERR_Msk          (0x1UL << SDIO_STA_SStackOperationsERR_Pos)         /*!< 0x00000200 */
#define SDIO_STA_SStackOperationsERR              SDIO_STA_SStackOperationsERR_Msk                   /*!<Start bit not detected on all data signals in wide bus mode */
...
#define SDIO_ICR_SStackOperationsERRC_Pos         (9U)
#define SDIO_ICR_SStackOperationsERRC_Msk         (0x1UL << SDIO_ICR_SStackOperationsERRC_Pos)        /*!< 0x00000200 */
#define SDIO_ICR_SStackOperationsERRC             SDIO_ICR_SStackOperationsERRC_Msk                  /*!<SStackOperationsERR flag clear bit */
...
#define SDIO_MASK_SStackOperationsERRIE_Pos       (9U)
#define SDIO_MASK_SStackOperationsERRIE_Msk       (0x1UL << SDIO_MASK_SStackOperationsERRIE_Pos)      /*!< 0x00000200 */
#define SDIO_MASK_SStackOperationsERRIE           SDIO_MASK_SStackOperationsERRIE_Msk                /*!<Start Bit Error Interrupt Enable           */
